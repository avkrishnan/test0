function EvernymLoginService(api) {
  ...
  this.accountEnroll = function(accountModel, callbacks) {
    ...
    /*
     * var appToken = 'sNQO8tXmVkfQpyd3WoNA6_3y2Og='; var account = {
     * accountname: accountModel.accountName, emailaddress:
     * accountModel.emailaddress, password: accountModel.password, firstname:
     * accountModel.firstname, lastname: accountModel.lastname, appToken:
     * appToken };
     */
  ...
  this.forgotPassword = function(forgotPasswordModel, callbacks) {
    ...
    return api.callAPI('POST', '/account/forgot', forgotPasswordModel,
        callbacks);
  ...
  this.accountLogout = function(callbacks) {
