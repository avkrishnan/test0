...
function LoginViewModel() {
	...
	*/
	...
	function errorBg(elementRemoveClass, elementAddClass) {
		$(elementRemoveClass).removeClass('typeerrormsg');
		$(elementAddClass).addClass('typeerrormsg');
		$(elementAddClass).parent().addClass('validationerror');
	}
